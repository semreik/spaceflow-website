    ...
    <div className="relative bg-white/[0.03] backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h3 className="text-base sm:text-lg font-semibold text-white/90">Vendor Portfolio</h3>
          <span className="text-xs text-white/40">Industrial Equipment</span>
        </div>
          ...
          {vendors.map((vendor, idx) => (
            <div key={idx} className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.05]">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 rounded bg-white/10 flex items-center justify-center text-xs font-medium text-white/70">
                  {vendor.logo}
                </div>
                <span className="text-white/90 text-sm font-medium">{vendor.name}</span>
                <span className="ml-auto text-xs text-white/60">{vendor.tier}</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                ...
                <div>
                  ...
                  <span className="text-white/70">{vendor.owner}</span>
                </div>
              </div>
            </div>
          ))}
    ...
    <div className="relative bg-white/[0.03] backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-sm font-medium text-white/90">Risk Monitor</span>
              <span className="text-xs text-white/40">Just now</span>
            </div>
            <div className="bg-white/[0.05] backdrop-blur rounded-2xl rounded-tl-sm px-4 py-3 max-w-sm border border-white/[0.08]">
              <p className="text-sm text-white/80">⚠️ High risk vendor detected: TechCorp Solutions missing SOC2 certification. Immediate review required.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-sm font-medium text-white/90">SpaceFlow AI</span>
              <span className="text-xs text-white/40">Analyzing...</span>
            </div>
            <div className="bg-white/[0.05] backdrop-blur rounded-2xl rounded-tl-sm px-4 py-3 border border-white/[0.08]">
              <p className="text-sm text-white/80 mb-3">I've identified 3 critical risks across your vendor portfolio. Here's what needs attention:</p>
              
              <div className="space-y-2 mb-3">
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-2 h-2 rounded-full bg-red-400/60"></div>
                  <span className="text-white/70">TechCorp Solutions - Missing compliance docs</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-2 h-2 rounded-full bg-amber-400/60"></div>
                  <span className="text-white/70">DataFlow Inc - Outdated security assessment</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-2 h-2 rounded-full bg-slate-400/60"></div>
                  <span className="text-white/70">SecureVault Ltd - Contract renewal due</span>
                </div>
              </div>
              
              <div className="flex items-center gap-2 text-xs text-white/50">
                <span>Overall risk score: 98% compliant</span>
                <span className="px-2 py-1 rounded-full bg-white/10 text-white/60">3 items need review</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          <button className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/[0.05] border border-white/[0.08] text-sm text-white/70 hover:bg-white/[0.08] transition-colors">
            <span>Generate report</span>
          </button>
          <button className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white font-medium transition-colors" style={{ background: `${color}88` }}>
